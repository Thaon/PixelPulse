...
(() => {
  ...
  var w = Math.pow,
    Dn = (i, t, e) =>
      t in i
        ? Sr(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
        : (i[t] = e),
    se = (i, t) => {
  ...
  var _r = (i, t, e) => (
    ...
    Bc(
      t || !i || !i.__esModule
        ? Sr(e, "default", { value: i, enumerable: !0 })
        : e,
      i
    )
  );
  ...
  var p = (i, t, e) => (
      Or(i, t, "read from private field"), e ? e.call(i) : t.get(i)
    ),
    A = (i, t, e) => {
      if (t.has(i))
    ...
    P = (i, t, e, r) => (
      Or(i, t, "write to private field"), r ? r.call(i, e) : t.set(i, e), e
    );
  ...
  var Ln = R((Ei) => {
    ...
    for (ce = 0, Pn = Nr.length; ce < Pn; ++ce)
      (bt[ce] = Nr[ce]), (ut[Nr.charCodeAt(ce)] = ce);
    var ce, Pn;
    ut["-".charCodeAt(0)] = 62;
    ...
    function Vc(i) {
      ...
      return (
        n === 2 &&
          ((t = (ut[i.charCodeAt(a)] << 2) | (ut[i.charCodeAt(a + 1)] >> 4)),
          (o[s++] = t & 255)),
        n === 1 &&
          ((t =
            (ut[i.charCodeAt(a)] << 10) |
            (ut[i.charCodeAt(a + 1)] << 4) |
            (ut[i.charCodeAt(a + 2)] >> 2)),
          (o[s++] = (t >> 8) & 255),
          (o[s++] = t & 255)),
        o
      );
    ...
    function Fc(i) {
      return (
        bt[(i >> 18) & 63] + bt[(i >> 12) & 63] + bt[(i >> 6) & 63] + bt[i & 63]
      );
    }
    function Hc(i, t, e) {
    ...
    function Gc(i) {
      for (
        var t, e = i.length, r = e % 3, n = [], o = 16383, s = 0, c = e - r;
        s < c;
        s += o
      )
  ...
  var Mn = R((Tr) => {
    ...
    Tr.read = function (i, t, e, r, n) {
      var o,
        ...
        O = i[t + E];
      for (
        E += N, o = O & ((1 << -h) - 1), O >>= -h, h += c;
        h > 0;
        o = o * 256 + i[t + E], E += N, h -= 8
      );
      for (
        s = o & ((1 << -h) - 1), o >>= -h, h += r;
        h > 0;
        s = s * 256 + i[t + E], E += N, h -= 8
      );
      if (o === 0) o = 1 - l;
      else {
  ...
  var Xn = R((Oe) => {
    ...
    function Yc(i, t) {
      if (
        ((typeof t != "string" || t === "") && (t = "utf8"), !f.isEncoding(t))
      )
    ...
    function Kc(i) {
      ...
      if (i.length !== void 0)
        return typeof i.length != "number" || Dr(i.length) ? Mt(0) : vr(i);
    ...
    function ia(i, t, e) {
      return t === 0 && e === i.length
        ? Ir.fromByteArray(i)
        : Ir.fromByteArray(i.slice(t, e));
    }
    function qn(i, t, e) {
    ...
    function ra(i) {
      ...
      let e = "",
        r = 0;
      for (; r < t; )
        e += String.fromCharCode.apply(String, i.slice(r, (r += xn)));
      return e;
    }
    function na(i, t, e) {
      let r = "";
    ...
    function ca(i, t, e) {
      ...
      for (let o = 0; o < r.length - 1; o += 2)
        n += String.fromCharCode(r[o] + r[o + 1] * 256);
      return n;
    }
    ...
    f.prototype.readUint16LE = f.prototype.readUInt16LE = function (t, e) {
      return (
        (t = t >>> 0), e || q(t, 2, this.length), this[t] | (this[t + 1] << 8)
      );
    };
    f.prototype.readUint16BE = f.prototype.readUInt16BE = function (t, e) {
      return (
        (t = t >>> 0), e || q(t, 2, this.length), (this[t] << 8) | this[t + 1]
      );
    };
    ...
    f.prototype.readBigUInt64LE = xt(function (t) {
      ...
      let n =
          e + this[++t] * w(2, 8) + this[++t] * w(2, 16) + this[++t] * w(2, 24),
        o =
          this[++t] + this[++t] * w(2, 8) + this[++t] * w(2, 16) + r * w(2, 24);
    ...
    f.prototype.readBigUInt64BE = xt(function (t) {
      ...
      (e === void 0 || r === void 0) && We(t, this.length - 8);
      let n =
          e * w(2, 24) + this[++t] * w(2, 16) + this[++t] * w(2, 8) + this[++t],
        o =
          this[++t] * w(2, 24) + this[++t] * w(2, 16) + this[++t] * w(2, 8) + r;
    ...
    f.prototype.readBigInt64BE = xt(function (t) {
      ...
      (e === void 0 || r === void 0) && We(t, this.length - 8);
      let n =
        (e << 24) + this[++t] * w(2, 16) + this[++t] * w(2, 8) + this[++t];
      return (
        (BigInt(n) << BigInt(32)) +
        BigInt(
          this[++t] * w(2, 24) + this[++t] * w(2, 16) + this[++t] * w(2, 8) + r
    ...
    f.prototype.readFloatLE = function (t, e) {
      return (
        (t = t >>> 0), e || q(t, 4, this.length), Se.read(this, t, !0, 23, 4)
      );
    };
    f.prototype.readFloatBE = function (t, e) {
      return (
        (t = t >>> 0), e || q(t, 4, this.length), Se.read(this, t, !1, 23, 4)
      );
    };
    f.prototype.readDoubleLE = function (t, e) {
      return (
        (t = t >>> 0), e || q(t, 8, this.length), Se.read(this, t, !0, 52, 8)
      );
    };
    f.prototype.readDoubleBE = function (t, e) {
      return (
        (t = t >>> 0), e || q(t, 8, this.length), Se.read(this, t, !1, 52, 8)
      );
    };
    ...
    f.prototype.writeIntLE = function (t, e, r, n) {
      ...
      for (this[e] = t & 255; ++o < r && (s *= 256); )
        t < 0 && c === 0 && this[e + o - 1] !== 0 && (c = 1),
          (this[e + o] = (((t / s) >> 0) - c) & 255);
      return e + r;
    };
      ...
      function (i, t, e) {
        ...
        return (
          Number.isInteger(e) && Math.abs(e) > w(2, 32)
            ...
            : typeof e == "bigint" &&
              ((n = String(e)),
              (e > w(BigInt(2), BigInt(32)) || e < -w(BigInt(2), BigInt(32))) &&
                (n = jn(n)),
              (n += "n")),
    ...
    function aa(i, t, e) {
      _e(t, "offset"),
        (i[t] === void 0 || i[t + e] === void 0) && We(t, i.length - (e + 1));
    }
    ...
    function _e(i, t) {
      if (typeof i != "number")
        throw new Re.ERR_INVALID_ARG_TYPE(t, "number", i);
    }
    function We(i, t, e) {
    ...
    function la(i) {
      if (((i = i.split("=")[0]), (i = i.trim().replace(ua, "")), i.length < 2))
        return "";
    ...
    function Ri(i, t, e, r) {
      let n;
      for (n = 0; n < r && !(n + e >= t.length || n >= i.length); ++n)
        t[n + e] = i[n];
      return n;
    }
    function Ct(i, t) {
  ...
  var no = R((Oi) => {
    ...
    (function (i) {
      (i[(i.UNKNOWN = 0)] = "UNKNOWN"),
        ...
        (i[(i.SUBSCRIPTION_HAS_NO_PROVIDER = 32)] =
          "SUBSCRIPTION_HAS_NO_PROVIDER"),
        (i[(i.SUBSCRIPTION_FOR_PATTERN_FOUND = 33)] =
          "SUBSCRIPTION_FOR_PATTERN_FOUND"),
        (i[(i.SUBSCRIPTION_FOR_PATTERN_REMOVED = 34)] =
  ...
  var so = R((Ti) => {
    ...
    (function (i) {
      (i[(i.UNKNOWN = 0)] = "UNKNOWN"),
        ...
        (i[(i.SUBSCRIPTION_HAS_NO_PROVIDER = 10)] =
          "SUBSCRIPTION_HAS_NO_PROVIDER"),
        (i[(i.SUBSCRIPTION_FOR_PATTERN_FOUND = 11)] =
          "SUBSCRIPTION_FOR_PATTERN_FOUND"),
        (i[(i.SUBSCRIPTION_FOR_PATTERN_REMOVED = 12)] =
          "SUBSCRIPTION_FOR_PATTERN_REMOVED"),
  ...
  var co = R((Ii) => {
    ...
    (function (i) {
      (i[(i.UNKNOWN = 0)] = "UNKNOWN"),
        ...
        (i[(i.INVALID_RPC_CORRELATION_ID = 103)] =
  ...
  var fo = R((gi) => {
    ...
    (function (i) {
      (i[(i.UNKNOWN = 0)] = "UNKNOWN"),
        ...
        (i[(i.MAXIMUM_MESSAGE_SIZE_EXCEEDED = 5)] =
  ...
  var po = R((Ai) => {
    ...
    var ga;
    (function (i) {})(
      (ga = Ai.MONITORING_ACTION || (Ai.MONITORING_ACTION = {}))
    );
  });
  var Eo = R((Ie) => {
    "use strict";
    ...
    (function (i) {
      (i[(i.EVENT_SUBSCRIPTIONS = 11)] = "EVENT_SUBSCRIPTIONS"),
        ...
        (i[(i.RECORD_PUBLISHED_SUBSCRIPTIONS = 17)] =
          "RECORD_PUBLISHED_SUBSCRIPTIONS"),
        (i[(i.EVENT_PUBLISHED_SUBSCRIPTIONS = 18)] =
          "EVENT_PUBLISHED_SUBSCRIPTIONS"),
  ...
  var F = R((X) => {
    ...
    X.RESPONSE_TO_REQUEST =
      ...
      (be[W.TOPIC.PRESENCE] =
        ...
        (Di[W.PRESENCE_ACTION.QUERY_ALL_RESPONSE] =
          W.PRESENCE_ACTION.QUERY_ALL),
        Di)),
      (be[W.TOPIC.RPC] =
        ((wi = {}),
    ...
    (function (i) {
      (i.RECORD_READ_ONLY_MODE = "RECORD_READ_ONLY_MODE"),
        ...
        (i.MAX_RECONNECTION_ATTEMPTS_REACHED =
      ...
      return (
        (i.prototype.on = function (t, e, r) {
          ...
          return (
            n
              ? n.push({ fn: e, scope: r })
              : ((n = [{ fn: e, scope: r }]), this.callbacks.set(t, n)),
            this
          );
        }),
        ...
        (i.prototype.removeContext = function (t) {
          ...
          if (this.callbacks !== null)
            try {
              for (
                var n = Ja(this.callbacks), o = n.next();
                !o.done;
                o = n.next()
              ) {
                var s = Oo(o.value, 2),
      ...
      tu = (function (i) {
        ...
        return (
          (t.prototype.add = function (e) {
            if (
              (e.duration === void 0 &&
                (e.duration = this.options.subscriptionTimeout),
            ...
            var r = {
              timerId: -1,
              uniqueName: this.getUniqueName(e.message),
              timeout: e,
            };
            return (
          ...
          (t.prototype.clear = function (e) {
            ...
            r &&
              (this.register.delete(e),
              this.services.timerRegistry.remove(r.timerId));
          }),
          (t.prototype.onTimeout = function (e) {
            this.register.delete(e.uniqueName);
            var r = e.timeout;
            r.callback
              ? r.callback(r.event, r.message)
              : this.services.logger.warn(r.message, r.event);
          }),
          ...
          (t.prototype.onConnectionLost = function () {
            ...
            try {
              for (
                var n = za(this.register), o = n.next();
                !o.done;
                o = n.next()
              ) {
                var s = Xa(o.value, 2),
                  c = s[0],
                  a = s[1];
                this.services.timerRegistry.remove(a.timerId),
                  this.register.delete(c);
              }
            } catch (l) {
              e = { error: l };
            } finally {
    ...
    var ru = (function () {
      ...
      return (
        ...
        (i.prototype.triggerTimeouts = function () {
          ...
          try {
            for (
              var n = eu(this.registry), o = n.next();
              !o.done;
              o = n.next()
            ) {
              var s = iu(o.value, 2),
                c = s[0],
                a = s[1];
              r - a.created > a.duration &&
                (a.callback.call(a.context, a.data), this.registry.delete(c));
            }
          } catch (l) {
            t = { error: l };
          } finally {
  ...
  var Co = R((Wh, bo) => {
    ...
    function ou(i, t) {
      for (
        var e = new Array(arguments.length - 1), r = 0, n = 2, o = !0;
        n < arguments.length;
  ...
  var Do = R((Ao) => {
    ...
    Bi.encode = function (t, e, r) {
      for (var n = null, o = [], s = 0, c = 0, a; e < r; ) {
        ...
        s > 8191 &&
          ((n || (n = [])).push(String.fromCharCode.apply(String, o)), (s = 0));
      }
      return (
  ...
  var jo = R((Kh, xo) => {
      ...
      return (
        typeof Float32Array != "undefined"
          ...
          : (function () {
              ...
              (i.writeFloatLE = t.bind(null, Lo)),
                (i.writeFloatBE = t.bind(null, Mo));
              function e(r, n, o) {
                var s = r(n, o),
                  c = (s >> 31) * 2 + 1,
                  a = (s >>> 23) & 255,
              ...
              (i.readFloatLE = e.bind(null, Bo)),
                (i.readFloatBE = e.bind(null, ko));
            })(),
        typeof Float64Array != "undefined"
          ...
          : (function () {
              function t(r, n, o, s, c, a) {
                var l = s < 0 ? 1 : 0;
                if ((l && (s = -s), s === 0))
                  r(0, c, a + n), r(1 / s > 0 ? 0 : 2147483648, c, a + o);
              ...
              (i.writeDoubleLE = t.bind(null, Lo, 0, 4)),
                (i.writeDoubleBE = t.bind(null, Mo, 4, 0));
              ...
              (i.readDoubleLE = e.bind(null, Bo, 0, 4)),
                (i.readDoubleBE = e.bind(null, ko, 4, 0));
            })(),
        i
      );
    }
    ...
    function Bo(i, t) {
      return (
        (i[t] | (i[t + 1] << 8) | (i[t + 2] << 16) | (i[t + 3] << 24)) >>> 0
      );
    }
    function ko(i, t) {
      return (
        ((i[t] << 24) | (i[t + 1] << 16) | (i[t + 2] << 8) | i[t + 3]) >>> 0
      );
    }
  });
      ...
      for (var n = r, o, s, c = 0; c < t.length; ++c)
        (o = t.charCodeAt(c)),
          o < 128
            ...
            : (o & 64512) === 55296 &&
              ((s = t.charCodeAt(c + 1)) & 64512) === 56320
    ...
    S.oneOfGetter = function (t) {
      ...
      return function () {
        for (var n = Object.keys(this), o = n.length - 1; o > -1; --o)
          if (e[n[o]] === 1 && this[n[o]] !== void 0 && this[n[o]] !== null)
            return n[o];
      };
    };
  ...
  var Hr = R((Zh, Xo) => {
    ...
    ht.Array !== Array &&
      (g.alloc = ht.pool(g.alloc, ht.Array.prototype.subarray));
    g.prototype._push = function (t, e, r) {
      return (
        (this.tail = this.tail.next = new Qe(t, e, r)), (this.len += e), this
      );
    };
    function jr(i, t, e) {
      t[e] = i & 255;
    ...
    g.prototype.fork = function () {
      return (
        (this.states = new au(this)),
        (this.head = this.tail = new Qe(xr, 0, 0)),
        (this.len = 0),
        this
      );
    };
  ...
  var es = R((tf, ts) => {
    ...
    At._configure = function () {
      (At.alloc = Ht._Buffer_allocUnsafe),
        (At.writeBytesBuffer =
          Ht.Buffer &&
          Ht.Buffer.prototype instanceof Uint8Array &&
          Ht.Buffer.prototype.set.name === "set"
            ? function (t, e, r) {
                e.set(t, r);
              }
            : function (t, e, r) {
  ...
  var Wr = R((ef, ss) => {
    ...
    function yt(i, t) {
      return RangeError(
        "index out of range: " + i.pos + " + " + (t || 1) + " > " + i.len
      );
    }
    function j(i) {
    ...
    j.create = os();
    j.prototype._slice =
      Dt.Array.prototype.subarray || Dt.Array.prototype.slice;
    ...
    function Gr() {
      ...
      if (this.len - this.pos > 4) {
        for (; t < 4; ++t)
          if (
            ((i.lo = (i.lo | ((this.buf[this.pos] & 127) << (t * 7))) >>> 0),
            this.buf[this.pos++] < 128)
          )
            return i;
        if (
        ...
        return (
          (i.lo = (i.lo | ((this.buf[this.pos++] & 127) << (t * 7))) >>> 0), i
        );
      }
      if (this.len - this.pos > 4) {
        for (; t < 5; ++t)
          if (
            ((i.hi =
              (i.hi | ((this.buf[this.pos] & 127) << (t * 7 + 3))) >>> 0),
            this.buf[this.pos++] < 128)
          )
            return i;
      } else
    ...
    function ji(i, t) {
      return (
        (i[t - 4] | (i[t - 3] << 8) | (i[t - 2] << 16) | (i[t - 1] << 24)) >>> 0
      );
    }
  ...
  var fs = R((nf, hs) => {
    ...
    ze.prototype.rpcCall = function i(t, e, r, n, o) {
      ...
      try {
        return s.rpcImpl(
          t,
          e[s.requestDelimited ? "encodeDelimited" : "encode"](n).finish(),
          function (a, l) {
    ...
    C.AuthMessage = (function () {
      ...
      return (
        ...
        (i.encode = function (e, r) {
          return (
            ...
            e.action != null &&
              ...
              r.uint32(8).int32(e.action),
            e.data != null &&
              Object.hasOwnProperty.call(e, "data") &&
              r.uint32(18).string(e.data),
            e.isError != null &&
              Object.hasOwnProperty.call(e, "isError") &&
              r.uint32(24).bool(e.isError),
            e.isAck != null &&
              Object.hasOwnProperty.call(e, "isAck") &&
              r.uint32(32).bool(e.isAck),
            r
          );
        }),
        ...
        (i.decode = function (e, r) {
          ...
          for (
            var n = r === void 0 ? e.len : e.pos + r, o = new C.AuthMessage();
            e.pos < n;
      ...
      return (
        ...
        (i.encode = function (e, r) {
          if (
            ...
            e.isError != null &&
              Object.hasOwnProperty.call(e, "isError") &&
              r.uint32(32).bool(e.isError),
            e.isAck != null &&
              Object.hasOwnProperty.call(e, "isAck") &&
              r.uint32(40).bool(e.isAck),
            e.name != null &&
              Object.hasOwnProperty.call(e, "name") &&
              r.uint32(50).string(e.name),
            e.names != null && e.names.length)
          )
            for (var n = 0; n < e.names.length; ++n)
              r.uint32(58).string(e.names[n]);
          return (
            e.subscription != null &&
        ...
        (i.decode = function (e, r) {
          e instanceof I || (e = I.create(e));
          for (
            var n = r === void 0 ? e.len : e.pos + r, o = new C.EventMessage();
            e.pos < n;
            ...
            switch (s >>> 3) {
              ...
              case 6:
                ...
                break;
              case 7:
                (o.names && o.names.length) || (o.names = []),
    ...
    C.Message = (function () {
      ...
      return (
        ...
        (i.decode = function (e, r) {
          e instanceof I || (e = I.create(e));
          for (
            var n = r === void 0 ? e.len : e.pos + r, o = new C.Message();
            e.pos < n;
    ...
    C.LockMessage = (function () {
      ...
      return (
        ...
        (i.encode = function (e, r) {
          return (
            ...
            e.action != null &&
              ...
              r.uint32(8).int32(e.action),
            e.locked != null &&
              Object.hasOwnProperty.call(e, "locked") &&
              r.uint32(24).bool(e.locked),
            r
          );
        }),
        (i.encodeDelimited = function (e, r) {
        ...
        (i.decode = function (e, r) {
          e instanceof I || (e = I.create(e));
          for (
            var n = r === void 0 ? e.len : e.pos + r, o = new C.LockMessage();
            e.pos < n;
    ...
    C.ParserMessage = (function () {
      ...
      return (
        ...
        (i.decode = function (e, r) {
          e instanceof I || (e = I.create(e));
          for (
            var n = r === void 0 ? e.len : e.pos + r, o = new C.ParserMessage();
            e.pos < n;
      ...
      return (
        ...
        (i.encode = function (e, r) {
          if (
            ...
            e.data != null &&
              Object.hasOwnProperty.call(e, "data") &&
              r.uint32(34).string(e.data),
            e.correlationId != null &&
              Object.hasOwnProperty.call(e, "correlationId") &&
              r.uint32(42).string(e.correlationId),
            e.isError != null &&
              Object.hasOwnProperty.call(e, "isError") &&
              r.uint32(48).bool(e.isError),
            e.isAck != null &&
              Object.hasOwnProperty.call(e, "isAck") &&
              r.uint32(56).bool(e.isAck),
            e.name != null &&
              Object.hasOwnProperty.call(e, "name") &&
        ...
        (i.encode = function (e, r) {
          ...
          if (
            ...
            e.path != null &&
              ...
              r.uint32(98).string(e.path),
            e.version != null &&
              Object.hasOwnProperty.call(e, "version") &&
              r.uint32(104).int32(e.version),
      ...
      return (
        ...
        (i.encode = function (e, r) {
          if (
            ...
            for (var n = 0; n < e.names.length; ++n)
              r.uint32(50).string(e.names[n]);
          return (
            e.name != null &&
              Object.hasOwnProperty.call(e, "name") &&
              r.uint32(58).string(e.name),
            e.originalAction != null &&
              Object.hasOwnProperty.call(e, "originalAction") &&
              r.uint32(72).int32(e.originalAction),
        ...
        (i.decode = function (e, r) {
          e instanceof I || (e = I.create(e));
          for (
            var n = r === void 0 ? e.len : e.pos + r, o = new C.RpcMessage();
            e.pos < n;
      ...
      return (
        ...
        (i.encode = function (e, r) {
          if (
            ...
            for (var n = 0; n < e.fullState.length; ++n)
              r.uint32(162).string(e.fullState[n]);
          return (
            e.serverName != null &&
        ...
        (i.decode = function (e, r) {
          e instanceof I || (e = I.create(e));
          for (
            var n = r === void 0 ? e.len : e.pos + r, o = new C.StateMessage();
            e.pos < n;
            ...
            switch (s >>> 3) {
              ...
              case 19:
                ...
                break;
              case 20:
                (o.fullState && o.fullState.length) || (o.fullState = []),
                  o.fullState.push(e.string());
                break;
              case 21:
      ...
      return (
        ...
        i.parsedData !== void 0 || i.data === void 0
          ...
          : ((i.parsedData = JSON.parse(i.data)),
            i.parsedData === void 0
              ? new Error(`unable to parse data ${i.data}`)
              : !0)
      );
    }
    Fi.parseData = Ru;
    ...
    var Su = (function () {
      function i(t, e) {
        (this.stateMachine = e),
          ...
          (this.history = [
            { oldState: "-", newState: this.state, transitionName: "-" },
          ]);
      }
      return (
        (i.prototype.transition = function (t) {
          for (var e, r = 0; r < this.transitions.length; r++)
            if (
              ((e = this.transitions[r]),
              t === e.name && (this.state === e.from || e.from === void 0))
            ) {
              this.history.push({
                oldState: this.state,
                transitionName: t,
...
History: ` +
  ...
  var Bt = R((J) => {
    ...
    var Nu = function (i) {
      ...
      if (typeof i == "object") {
        for (
          var t = Object.create(null), e = Object.keys(i), r = 0;
          r < e.length;
          r++
        )
          t[e[r]] = i[e[r]];
    ...
    var Cu = function (i, t) {
      ...
      if (
        ...
        i.length === t + 2 &&
          ...
          o(i[t])
            ? (e.data = n(i[t + 1]) ? i[t + 1] : void 0)
            : (e.data = r(i[t]) ? i[t] : void 0),
        ...
        if (
          (e.path !== void 0 && e.path.length === 0) ||
          (e.path === void 0 && !e.data)
        )
          throw Error("Invalid set path argument");
        if (e.data === void 0 && e.path === void 0)
          throw Error("Invalid set data argument");
        if (
          (e.callback !== void 0 && e.callback === !1) ||
          (e.callback === void 0 && i.length === t + 3)
        )
        ...
        function i(t, e, r, n) {
          ...
          (this.stateMachine = new wu.StateMachine(this.services.logger, {
                  ...
                  ? ((o.isInLimbo = !0),
                    ...
                    l !== d.CONNECTION_STATE.CLOSED &&
                      ...
                      (o.limboTimeout = o.services.timerRegistry.add({
                        ...
                        callback: function () {
                          (o.isInLimbo = !1),
                            o.internalEmitter.emit(d.EVENT.EXIT_LIMBO);
                        },
                      }))))
            ...
            transitions: [
              ...
              {
                name: "closed",
                from: d.CONNECTION_STATE.CLOSING,
                to: d.CONNECTION_STATE.CLOSED,
              },
              {
                name: "offline",
                from: d.CONNECTION_STATE.PAUSING,
                to: d.CONNECTION_STATE.OFFLINE,
              },
        ...
        return (
          ...
          (i.prototype.authenticate = function (t, e) {
            ...
            if (
              ...
              this.stateMachine.state ===
                d.CONNECTION_STATE.TOO_MANY_AUTH_ATTEMPTS ||
              this.stateMachine.state ===
                d.CONNECTION_STATE.AUTHENTICATION_TIMEOUT
            ) {
            ...
            t && (this.authParams = typeof t == "object" ? t : {}),
              ...
              this.stateMachine.state ===
                d.CONNECTION_STATE.AWAITING_AUTHENTICATION &&
                this.authParams &&
                this.sendAuthParams(),
          ...
          (i.prototype.close = function () {
            this.services.timerRegistry.remove(this.heartbeatIntervalTimeout),
              this.sendMessage({
                topic: d.TOPIC.CONNECTION,
                action: d.CONNECTION_ACTION.CLOSING,
              }),
          ...
          (i.prototype.onError = function (t) {
            ...
            setTimeout(function () {
              ...
              t.code === "ECONNRESET" || t.code === "ECONNREFUSED"
                ? (r =
                    "Can't connect! Deepstream server unreachable on " +
                    e.originalUrl)
                : (r = t),
                e.services.logger.error(
                  { topic: d.TOPIC.CONNECTION },
                  d.EVENT.CONNECTION_ERROR,
                  r
                );
            }, 1),
              this.services.timerRegistry.remove(this.heartbeatIntervalTimeout),
          ...
          (i.prototype.onClose = function () {
            if (
              (this.services.timerRegistry.remove(
            ...
            if (
              !(
                this.stateMachine.state ===
                  d.CONNECTION_STATE.CHALLENGE_DENIED ||
                this.stateMachine.state ===
                  d.CONNECTION_STATE.TOO_MANY_AUTH_ATTEMPTS ||
                this.stateMachine.state ===
                  d.CONNECTION_STATE.AUTHENTICATION_TIMEOUT
              ...
              this.stateMachine.transition("connection-lost"),
                this.tryReconnect();
            }
          }),
          ...
          (i.prototype.tryReconnect = function () {
            if (this.reconnectTimeout === null) {
              if (
                this.reconnectionAttempt < this.options.maxReconnectAttempts
              ) {
                this.stateMachine.transition("reconnect"),
                  (this.reconnectTimeout = this.services.timerRegistry.add({
                    ...
                    duration: Math.min(
                      ...
                      this.options.reconnectIntervalIncrement *
          ...
          (i.prototype.handleConnectionResponse = function (t) {
            ...
            if (t.action === d.CONNECTION_ACTION.REJECT) {
              this.stateMachine.transition("challenge-denied"),
                this.endpoint && this.endpoint.close();
              return;
            }
          ...
          (i.prototype.handleAuthResponse = function (t) {
            if (t.action === d.AUTH_ACTION.TOO_MANY_AUTH_ATTEMPTS) {
              this.stateMachine.transition("too-many-auth-attempts"),
                this.services.logger.error(t);
              return;
            }
            if (t.action === d.AUTH_ACTION.AUTH_UNSUCCESSFUL) {
              this.stateMachine.transition("unsuccesful-login"),
                this.onAuthUnSuccessful();
              return;
            }
            if (t.action === d.AUTH_ACTION.AUTH_SUCCESSFUL) {
              this.stateMachine.transition("succesful-login"),
                this.onAuthSuccessful(t.parsedData);
              return;
            }
          }),
          ...
          (i.prototype.onAuthSuccessful = function (t) {
            this.updateClientData(t),
              ...
              this.authCallback !== null &&
                (this.authCallback(!0, this.clientData),
                (this.authCallback = null));
          }),
          (i.prototype.onAuthUnSuccessful = function () {
            ...
            if (
              (this.resumeCallback &&
                (this.resumeCallback(t), (this.resumeCallback = null)),
              this.authCallback === null)
            ) {
          ...
          (i.prototype.updateClientData = function (t) {
            var e = t || null;
            (this.clientData === null &&
              (e === null || Object.keys(e).length === 0)) ||
              bs.deepEquals(this.clientData, t) ||
              (this.emitter.emit(
                d.EVENT.CLIENT_DATA_CHANGED,
                Object.assign({}, e)
              ),
              (this.clientData = e));
          }),
    ...
    var xu = $r(),
      ...
      Vu = function (i, t, e) {
        ...
        var n =
          ...
          o = n(
            { topic: me.TOPIC.CONNECTION, action: me.CONNECTION_ACTION.PING },
            !1
          ),
          s = null,
          c = -1;
        return (
          ...
          (r.sendParsedMessage = function (a) {
            if (
              a.topic === me.TOPIC.CONNECTION &&
              a.action === me.CONNECTION_ACTION.CLOSING
            ) {
              r.onparsedmessages([
                {
                  topic: me.TOPIC.CONNECTION,
                  action: me.CONNECTION_ACTION.CLOSED,
                },
              ]),
                r.close();
              return;
        ...
        return (
          ...
          (i.prototype.handle = function (t) {
            ...
            if (t.action === this.actions.SUBSCRIPTION_FOR_PATTERN_REMOVED) {
              ...
              r &&
                (r(t.subscription), this.stopCallbacks.delete(t.subscription));
              return;
            }
          ...
          (i.prototype.sendListen = function (t) {
            ...
            this.services.timeoutRegistry.add({ message: e }),
        ...
        return (
          ...
          (i.prototype.subscribe = function (t, e) {
            ...
            this.emitter.hasListeners(t) ||
              (this.services.connection.isConnected &&
                this.bulkSubscription.subscribe(t)),
              this.emitter.on(t, e);
          }),
          (i.prototype.unsubscribe = function (t, e) {
            ...
            this.emitter.off(t, e),
              this.emitter.hasListeners(t) ||
                this.bulkSubscription.unsubscribe(t);
          }),
          ...
          (i.prototype.handle = function (t) {
            ...
            if (t.action === V.EVENT_ACTION.MESSAGE_DENIED) {
              this.services.logger.error(
                { topic: V.TOPIC.EVENT },
                V.EVENT_ACTION.MESSAGE_DENIED
              ),
                this.services.timeoutRegistry.remove(t),
                t.originalAction === V.EVENT_ACTION.SUBSCRIBE &&
                  this.emitter.off(t.name);
              return;
            }
            if (
              ...
              this.services.timeoutRegistry.remove(
                Ji(Ji({}, t), { action: V.EVENT_ACTION.SUBSCRIBE })
              ),
        ...
        return (
          ...
          (i.prototype.make = function (t, e, r) {
            ...
            if (this.services.connection.isConnected) {
              if (r) {
                this.rpcs.set(
                  o,
                  new Zr.RPC(t, o, e, r, this.options, this.services)
                );
                return;
              }
          ...
          (i.prototype.respondToRpc = function (t) {
            ...
            e
              ? e(
                  t.parsedData,
                  new zu.RPCResponse(t, this.options, this.services)
                )
              : this.services.connection.sendMessage({
                  topic: D.TOPIC.RPC,
          ...
          (i.prototype.getRPC = function (t) {
            ...
            return (
              e === void 0 &&
                this.services.logger.error(t, D.EVENT.UNKNOWN_CORRELATION_ID),
              e
            );
          }),
          (i.prototype.onConnectionReestablished = function () {
            ...
            for (var t = 0; t < this.limboQueue.length; t++) {
              ...
              this.rpcs.set(
                r,
                new Zr.RPC(n, r, o, s, this.options, this.services)
              );
            }
            this.limboQueue = [];
          }),
  ...
  var xs = R((De) => {
    ...
    function rl(i, t, e) {
      ...
      for (c = 0; c < r.length - 1; c++) {
        var a = r[c];
        if (s[a] !== void 0 && s[a] !== null && typeof s[a] == "object")
          s = s[a];
        ...
        if (n.length !== 0) {
          ...
          if (o.length !== 0) {
            ...
            for (var s = 1; s < o.length; s++)
              o[s].length !== 0 && t.push(Number(o[s]));
          }
        }
      }
      return t;
  ...
  var Vs = R((Kt) => {
        ...
        return (
          ...
          (t.prototype.onDirtyServiceLoaded = function () {
            ...
            this.services.storage.get(this.name, function (r, n, o) {
              if (
                (e.services.connection.onReestablished(
                  e.onConnectionReestablished
                ),
              ...
              n === -1 && !e.recordServices.dirtyService.isDirty(e.name)
                ? e.stateMachine.transition(
                    y.RECORD_ACTION.SUBSCRIBECREATEANDREAD
                  )
                : ((e.version = n),
                  (e.data = o),
                  e.stateMachine.transition("RESUBSCRIBE"));
            });
          }),
            ...
            if (!this.checkDestroyed("set")) {
              ...
              this.applyChange(a),
                this.services.connection.isConnected
                  ...
                  : (s && s(y.EVENT.CLIENT_OFFLINE, this.name),
                    this.saveUpdate());
            }
          }),
            ...
            this.checkDestroyed("subscribe") ||
              (e.triggerNow
                ? this.whenReadyInternal(null, function () {
                    n.emitter.on(e.path || "", e.callback, r),
                      e.callback(n.get(e.path));
                  })
          ...
          (t.prototype.unsubscribe = function (e, r) {
            ...
            if (e.callback !== void 0 && typeof e.callback != "function")
              throw new Error("invalid argument callback");
            this.checkDestroyed("unsubscribe") ||
              this.emitter.off(e.path || "", e.callback, r);
          }),
          (t.prototype.delete = function (e) {
            ...
            if (!this.checkDestroyed("delete"))
              if (
                ...
                return new Promise(function (n, o) {
                  (r.deleteResponse = { resolve: n, reject: o }),
                    r.sendDelete();
                });
          }),
          ...
          (t.prototype.onResubscribing = function () {
            this.services.timerRegistry.remove(this.readyTimer),
              ...
              (this.responseTimeout = this.services.timeoutRegistry.add({
                message: {
                  topic: y.TOPIC.RECORD,
                  action: y.RECORD_ACTION.HEAD,
                  name: this.name,
                },
              })),
              this.recordServices.bulkSubscriptionService[
                y.RECORD_ACTION.SUBSCRIBEANDHEAD
              ].subscribe(this.name);
          }),
          ...
          (t.prototype.applyPendingWrites = function () {
            for (
              var e = this, r = [], n = this.data, o = n, s = 0;
              s < this.pendingWrites.length;
              s++
            ) {
          ...
          (t.prototype.handle = function (e) {
            ...
            if (
              ...
              if (
                ...
                var r = Jt(Jt({}, e), {
                    originalAction: y.RECORD_ACTION.SUBSCRIBE,
                  }),
                  n = Jt(Jt({}, e), {
                    originalAction:
                      e.originalAction ===
                ...
                this.services.timeoutRegistry.remove(r),
                  this.services.timeoutRegistry.remove(n);
              }
              if (
                e.originalAction === y.RECORD_ACTION.PATCH &&
                e.correlationId
              ) {
            ...
            if (
              ...
              (this.hasProvider =
                e.action === y.RECORD_ACTION.SUBSCRIPTION_HAS_PROVIDER),
                this.emit(
                  y.EVENT.RECORD_HAS_PROVIDER_CHANGED,
                  this.hasProvider
                );
              return;
            }
          ...
          (t.prototype.handleHeadResponse = function (e) {
            ...
            this.recordServices.dirtyService.isDirty(this.name)
              ? r === -1 && this.version === this.options.initialRecordVersion
                ? (this.stateMachine.transition("SUBSCRIBED"),
          ...
          (t.prototype.sendUpdate = function (e, r, n) {
            ...
            e
              ? r === void 0
                ...
                : Object.assign(o, {
                    action: y.RECORD_ACTION.PATCH,
                    path: e,
                    parsedData: r,
                  })
              : Object.assign(o, {
                  action: y.RECORD_ACTION.UPDATE,
                  parsedData: r,
                }),
              n
          ...
          (t.prototype.applyChange = function (e, r, n) {
            if (
              ...
              var o = this.data;
              (this.data = e),
                this.options.saveUpdatesOffline &&
                  n &&
                  this.saveRecordToOffline();
              for (
                var s = this.emitter.eventNames(), c = 0;
                c < s.length;
                c++
              ) {
                var a = fe.get(e, s[c], !1),
                  l = fe.get(o, s[c], !1);
                (!we.deepEquals(a, l) || (r && a)) &&
                  this.emitter.emit(s[c], this.get(s[c]));
              }
            }
          }),
          ...
          (t.prototype.onRecordRecovered = function (e, r, n) {
            ...
            if (we.deepEquals(a, c)) {
              this.stateMachine.state === "MERGING" &&
          ...
          (t.prototype.checkDestroyed = function (e) {
            return this.stateMachine.inEndState
              ? (this.services.logger.error(
                  { topic: y.TOPIC.RECORD },
                  y.EVENT.RECORD_ALREADY_DESTROYED,
                  { methodName: e }
                ),
                !0)
              : !1;
    ...
    var sl = [
      ...
      },
      {
        ...
        from: "LOADING_OFFLINE",
        to: "READY",
        handler: $.prototype.onReady,
      },
      {
        name: y.RECORD_ACTION.READ_RESPONSE,
        from: "SUBSCRIBING",
        to: "READY",
        handler: $.prototype.onReady,
      },
      ...
      },
      {
        ...
        from: "LOADING_OFFLINE",
        to: "RESUBSCRIBING",
        handler: $.prototype.onResubscribing,
      },
      {
        name: "RESUBSCRIBE",
        from: "READY",
      ...
      {
        name: y.RECORD_ACTION.DELETE_SUCCESS,
        from: "DELETING",
        to: "DELETED",
        handler: $.prototype.onDeleted,
      },
      ...
      ul = (function (i) {
        ...
        function t(e) {
          ...
          return (
            ...
            (r.subscriptions = []),
            r.record.on(
              $t.EVENT.RECORD_READY,
              r.emit.bind(r, $t.EVENT.RECORD_READY, r),
              r
            ),
            r.record.on(
              $t.EVENT.RECORD_DISCARDED,
              r.emit.bind(r, $t.EVENT.RECORD_DISCARDED),
              r
            ),
            r.record.on(
              $t.EVENT.RECORD_DELETED,
              r.emit.bind(r, $t.EVENT.RECORD_DELETED),
              r
            ),
            r.record.on(
              $t.EVENT.RECORD_ERROR,
              r.emit.bind(r, $t.EVENT.RECORD_ERROR),
              r
            ),
    ...
    var Ue = Bt(),
      ...
      fl = (function (i) {
        ...
        function t(e) {
          var r = i.call(this) || this;
          return (
            (r.record = null), (r.subscriptions = []), (r.getRecordCore = e), r
          );
        }
        return (
          Object.defineProperty(t.prototype, "name", {
          ...
          (t.prototype.set = function (e, r, n) {
            if (this.record)
              return this.record.set(Ue.normalizeSetArguments(arguments));
          }),
          (t.prototype.setWithAck = function (e, r, n) {
            if (this.record)
              return this.record.setWithAck(
                Ue.normalizeSetArguments(arguments)
              );
          }),
          (t.prototype.erase = function (e) {
            if (this.record)
          ...
          (t.prototype.subscribe = function (e, r, n) {
            ...
            this.subscriptions.push(o),
              this.record && this.record.subscribe(o, this);
          }),
          (t.prototype.unsubscribe = function (e, r) {
        ...
        return (
          ...
          (t.prototype.setEntries = function (e, r) {
            ...
            for (o = 0; o < e.length; o++)
              if (typeof e[o] != "string") throw new Error(n);
            this.beforeChange(),
              this.record.set({ data: e, callback: r }),
              this.afterChange();
          }),
          (t.prototype.removeEntry = function (e, r, n) {
            ...
            for (a = 0; a < o.length; a++)
              (o[a] !== e || (s && r !== a)) && c.push(o[a]);
            this.beforeChange(),
              this.record.set({ data: c, callback: n }),
              this.afterChange();
          }),
          ...
          (t.prototype.beforeChange = function () {
            (this.hasAddListener = this.hasListeners(
              de.EVENT.ENTRY_ADDED_EVENT
            )),
              (this.hasRemoveListener = this.hasListeners(
                de.EVENT.ENTRY_REMOVED_EVENT
              )),
              (this.hasMoveListener = this.hasListeners(
                de.EVENT.ENTRY_MOVED_EVENT
              )),
              this.hasAddListener ||
              this.hasRemoveListener ||
          ...
          (t.prototype.getStructure = function () {
            ...
            for (r = 0; r < n.length; r++)
              e[n[r]] === void 0 ? (e[n[r]] = [r]) : e[n[r]].push(r);
            return e;
          }),
          (t.prototype.destroy = function () {
            for (var e = 0; e < this.subscriptions.length; e++)
          ...
          (i.prototype.recieve = function (t, e, r) {
            ...
            if (!(!o && !s)) {
              for (var c = 0; c < s.length; c++)
                s[c].callback.call(s[c].context, t);
        ...
        return (
          (i.prototype.send = function (t, e) {
            ...
            this.responses.set(r, e),
              this.services.connection.sendMessage(
                Zi(Zi({}, t), { correlationId: r, isWriteAck: !0 })
              ),
              this.count++;
          }),
          (i.prototype.recieve = function (t) {
            ...
            !r ||
              (t.action !== ti.RECORD_ACTION.WRITE_ACKNOWLEDGEMENT &&
                !t.isError &&
                !t.isWriteAck) ||
      ...
      return (
        ...
        (i.prototype.setDirty = function (t, e) {
          ...
          e ? this.dirtyRecords.set(t, !0) : (r = this.dirtyRecords.delete(t)),
            !this.flushTimeout &&
              r &&
              (this.flushTimeout = setTimeout(this.save, 1e3));
        }),
        (i.prototype.save = function () {
          this.storage.set(
            this.dirtyStorageName,
            1,
            Nl(this.dirtyRecords),
            function () {}
          ),
      ...
      bl = (function () {
        ...
        return (
          ...
          (i.prototype.merge = function (t, e, r, n, o) {
            ...
            try {
              for (
                var h = Il(this.strategiesByPattern), E = h.next();
                !E.done;
                E = h.next()
              ) {
                var N = vl(E.value, 2),
            ...
            this.services.logger.error(
              { topic: Js.TOPIC.RECORD },
              Js.EVENT.RECORD_VERSION_EXISTS,
              { remoteVersion: t.version, recordName: a }
            );
          }),
          i
        );
      ...
      kl = (function () {
          ...
          n === void 0 && (n = new Pl.Listener(v.TOPIC.RECORD, t)),
            ...
            (this.recordServices = r || {
              bulkSubscriptionService:
                ((o = {}),
                (o[v.RECORD_ACTION.SUBSCRIBECREATEANDREAD] =
                  this.getBulkSubscriptionService(
                    v.RECORD_ACTION.SUBSCRIBECREATEANDREAD
                  )),
                (o[v.RECORD_ACTION.SUBSCRIBEANDREAD] =
                  this.getBulkSubscriptionService(
                    v.RECORD_ACTION.SUBSCRIBEANDREAD
                  )),
                (o[v.RECORD_ACTION.SUBSCRIBEANDHEAD] =
                  this.getBulkSubscriptionService(
                    v.RECORD_ACTION.SUBSCRIBEANDHEAD
                  )),
                o),
              writeAckService: new Ul.WriteAcknowledgementService(t),
              readRegistry: new $s.SingleNotifier(
                t,
                v.RECORD_ACTION.READ,
                e.recordReadTimeout
              ),
              headRegistry: new $s.SingleNotifier(
                t,
                v.RECORD_ACTION.HEAD,
                e.recordReadTimeout
              ),
            ...
            this.services.connection.onReestablished(
              this.syncDirtyRecords.bind(this)
            ),
        ...
        return (
          ...
          (i.prototype.setDataWithAck = function (t) {
            for (var e = this, r = [], n = 1; n < arguments.length; n++)
              r[n - 1] = arguments[n];
          ...
          (i.prototype.sendSetData = function (t, e, r) {
            ...
            if (!t || typeof t != "string" || t.length === 0)
              throw new Error(
                "invalid argument: recordName must be an non empty string"
              );
            if (!n && (o === null || typeof o != "object"))
              throw new Error(
                "invalid argument: data must be an object when no path is provided"
              );
            ...
            s
              ? this.recordServices.writeAckService.send(l, s)
              : this.services.connection.sendMessage(l);
          }),
          ...
          (i.prototype.handle = function (t) {
            ...
            if (
              ...
              r
                ? (r(t.data || null),
                  this.notifyCallbacks.delete(t.correlationId))
            ...
            if (
              t.action === v.RECORD_ACTION.READ_RESPONSE ||
              t.originalAction === v.RECORD_ACTION.READ
            ) {
              t.isError
                ? this.recordServices.readRegistry.recieve(
                    t,
                    v.RECORD_ACTION[t.action]
                  )
                : this.recordServices.readRegistry.recieve(
                    t,
                    null,
            ...
            t.action === v.RECORD_ACTION.HEAD_RESPONSE_BULK &&
              ...
              (t.action === v.RECORD_ACTION.HEAD_RESPONSE ||
                t.originalAction === v.RECORD_ACTION.HEAD) &&
                (t.isError
          ...
          (i.prototype._syncDirtyRecords = function () {
            ...
            try {
              for (var n = ml(r), o = n.next(); !o.done; o = n.next()) {
                ...
                (a && a.references.size > 0) ||
                  this.services.storage.get(c, this.sendUpdatedData);
              }
            } catch (l) {
              t = { error: l };
            } finally {
            ...
            var o = function (s, c) {
              s
                ? n.recordServices.readRegistry.register(c, n, function (a) {
                    n.recordServices.mergeStrategy.merge(
                      a,
                      e,
                      r,
                      n.onMergeCompleted,
  ...
  var Xs = R((er) => {
    ...
    function jl(i) {
      ...
      if (i.length === 1)
        ...
        i.length === 2 &&
        ((t = i[0]), (e = i[1]), !Array.isArray(t) || typeof e != "function")
      )
      ...
      return (
        (i.prototype.subscribe = function (t, e) {
          if (typeof t == "string" && t.length > 0 && typeof e == "function") {
            var r = t;
            this.subscriptionEmitter.hasListeners(r) ||
              this.bulkSubscription.subscribe(r),
              this.subscriptionEmitter.on(r, e);
            return;
          }
          if (typeof t == "function" && typeof e == "undefined") {
            this.globalSubscriptionEmitter.hasListeners(Rt) ||
        ...
        (i.prototype.getAll = function () {
          ...
          if (o) {
            ...
            (s = {
              topic: U.TOPIC.PRESENCE,
              action: U.PRESENCE_ACTION.QUERY,
              correlationId: l,
              names: o,
            }),
              (c = this.queryEmitter),
            ...
            (s = {
              topic: U.TOPIC.PRESENCE,
              action: U.PRESENCE_ACTION.QUERY_ALL,
            }),
        ...
        (i.prototype.handle = function (t) {
          ...
          if (t.action === U.PRESENCE_ACTION.QUERY_ALL_RESPONSE) {
            this.queryAllEmitter.emit(Rt, null, t.names),
              this.services.timeoutRegistry.remove(t);
            return;
          }
        ...
        (i.prototype.subscribeToAllChanges = function () {
          if (!!this.services.connection.isConnected) {
            var t = {
              topic: U.TOPIC.PRESENCE,
              action: U.PRESENCE_ACTION.SUBSCRIBE_ALL,
            };
            this.services.timeoutRegistry.add({ message: t }),
              this.services.connection.sendMessage(t);
          }
        ...
        (i.prototype.unsubscribeToAllChanges = function () {
          if (!!this.services.connection.isConnected) {
            var t = {
              topic: U.TOPIC.PRESENCE,
              action: U.PRESENCE_ACTION.UNSUBSCRIBE_ALL,
            };
            this.services.timeoutRegistry.add({ message: t }),
              this.services.connection.sendMessage(t);
          }
        ...
        (i.prototype.onConnectionReestablished = function () {
          ...
          for (var r = 0; r < this.limboQueue.length; r++)
            this.sendQuery(this.limboQueue[r]);
          this.limboQueue = [];
        }),
        (i.prototype.onExitLimbo = function () {
          var t = this;
    ...
    var Gl = (function () {
      function i(t) {
        ...
        if (
          ...
          throw new Error(
            "IndexDB currently not supported when deepstream in node"
          );
        ...
        (N.onerror = function (O) {
          ...
          (N.onupgradeneeded = function () {
            ...
            n.forEach(function (L) {
              O.objectStoreNames.contains(L) ||
                O.createObjectStore(L, { keyPath: c });
            });
            for (var B = 0; B < O.objectStoreNames.length; B++)
              n.includes(O.objectStoreNames[B]) === !1 &&
                O.deleteObjectStore(O.objectStoreNames[B]);
      ...
      return (
          ...
          (r.onblocked = function () {
            ...
            (r.onerror = function (n) {
              var o =
                ...
                e.options.indexdb.storageDatabaseName;
        ...
        (i.prototype.flush = function () {
                  ...
                  case Xt.GET: {
                    ...
                    (m.onerror = function (It) {
                      ...
                      (m.onsuccess = function () {
                        m.result
                          ? b(Tt, m.result.version, m.result.data)
                          : b(Tt, -1, null);
                      });
                    break;
                  }
          ...
          try {
            for (
              var s = Fl(this.queuedRequests), c = s.next();
              !c.done;
              c = s.next()
            ) {
              var a = Hl(c.value, 2),
          ...
          e > -1
            ? ((r = t.recordName.substring(0, e)),
              this.options.indexdb.objectStoreNames.indexOf(r) === -1
                ...
                : (t.recordName = t.recordName.substring(
                    e + 1,
                    t.recordName.length
                  )))
            : (r = this.options.indexdb.defaultObjectStoreName);
          var n = this.queuedRequests.get(r);
          n === void 0 ? this.queuedRequests.set(r, [t]) : n.push(t),
            this.registerFlush();
        }),
        i
      );
        ...
        function t(e, r) {
          ...
          return (
            ...
            r.nativeTimerRegistry
              ...
              : (o.timerRegistry = new $l.IntervalTimerRegistry(
            ...
            (n.services = o),
            n.services.connection.onLost(
              o.timeoutRegistry.onConnectionLost.bind(o.timeoutRegistry)
            ),
        ...
        return (
          (t.prototype.login = function (e, r) {
            ...
            if (e && typeof e == "object")
              ...
              this.services.connection.authenticate({}, e);
            else
              return new Promise(function (o, s) {
...
"${t}${kt.path}" ${kt.message}`),
  ...
  function nr(i, t) {
    return typeof i != "object"
      ? (st("User provided data is not an object."), !1)
      : ei(i, t);
  }
  function or(i) {
  ...
  function sn(i, t = "") {
    if (
      ((kt = null),
      ["string", "number", "boolean"].includes(typeof i) || i === null)
    )
      return !0;
    if (Array.isArray(i)) {
    ...
    return typeof i == "function"
      ? ((kt = {
        ...
        !1)
      : typeof i == "symbol"
      ? ((kt = { path: t, message: "is a symbol. Symbols are not allowed." }),
        !1)
      : typeof i == "object" &&
        nc(window.p5) &&
        i.constructor === window.p5.Color
      ? ((kt = {
          path: t,
    ...
    `,
      ...
      : typeof i == "object" &&
        nc(window.p5) &&
        i.constructor === window.p5.Vector
      ? ((kt = {
          path: t,
    ...
    `,
      ...
      : ((kt = {
          path: t,
          message:
            "is an unknown type. p5.party doesn't know what to do with it.",
        }),
        !1);
  }
  u();
  ...
  var uh = {
      after: (i, t) =>
        ct(i) ? i.slice(t.length) : t === "" ? i : i.slice(t.length + 1),
      concat: (i, t) =>
        ct(i)
          ? ((i = [...i]), t && i.push(t), i)
          : t && t.toString !== void 0
  ...
  var ni = class {
    ...
    _getOwnPropertyDescriptor(t, e) {
      ...
      return (
        n === void 0 &&
          ((n = Reflect.getOwnPropertyDescriptor(t, e)), (r[e] = n)),
        n
      );
    }
    getProxy(t, e, r, n) {
      ...
      return (
        c === void 0 &&
          ((c = o === void 0 ? new Proxy(t, r) : t),
          this._proxyCache.set(s, c)),
        c
      );
    }
    getPath(t) {
  ...
  function Ve(i, t) {
    ...
    let e;
    for (let [r, n] of i)
      if (((e = t.get(r)), e !== n || (e === void 0 && !t.has(r)))) return !0;
    return !1;
  }
  ...
  var K = class {
    ...
    _shallowClone(t) {
      ...
      if (ke(t)) e = se({}, t);
        ...
        e = new Set([...t].map((r) => this._shallowClone(r)));
    ...
    update(t, e, r) {
      ...
      if (e !== "length") {
        ...
        et.walk(n, (s) => {
          o &&
            o[s] &&
            (this._clonedCache.has(o[s]) || (o[s] = this._shallowClone(o[s])),
            (o = o[s]));
        }),
          this._hasOnValidate &&
            this._changes.push({ path: n, property: e, previous: r }),
          o && o[e] && (o[e] = r);
      }
      this._isChanged = !0;
    }
    ...
    isChanged(t) {
      return this._onIsChanged === void 0
        ? this._isChanged
        : this._onIsChanged(this.clone, t);
    }
  };
  u();
  ...
  var si = class extends K {
    constructor(t, e, r, n) {
      super(void 0, e, r, n),
        (this._arg1 = r[0]),
        (this._weakValue = t.has(this._arg1));
    }
    isChanged(t) {
    ...
    yn = (i, t, e = {}) => {
      ...
      let r = Symbol("ProxyTarget"),
        ...
        E = (_, T, b, m, x) =>
          !l ||
          h.isCloning ||
          e.onValidate(et.concat(a.getPath(_), T), b, m, x) === !0,
        N = (_, T, b, m) => {
          !sr(a, e, T) &&
            !(s && a.isDetached(_, i)) &&
            O(a.getPath(_), T, b, m);
        ...
        L = (_, T, b, m) =>
          ...
          (s && a.isDetached(T, i))
            ? _
            : (m === void 0 && (m = a.getPath(T)),
              a.getProxy(_, et.concat(m, b), pt, r)),
        pt = {
          get(_, T, b) {
            if (pe(T)) {
              if (T === r || T === ii) return _;
              if (T === an && !a.isUnsubscribed && a.getPath(_).length === 0)
                return a.unsubscribe(), _;
            }
          ...
          set(_, T, b, m) {
            ...
            let at = E(_, T, b, It);
            return at && a.setProperty(x, T, b, m, It)
              ? (N(_, T, _[T], It), !0)
              : !at;
          },
          ...
          deleteProperty(_, T) {
            ...
            let b = Reflect.get(_, T),
              m = E(_, T, void 0, b);
            return m && a.deleteProperty(_, T, b)
              ? (N(_, T, void 0, b), !0)
              : !m;
          },
          apply(_, T, b) {
            ...
            if (
              (c === !1 || (c !== !0 && !c.includes(_.name))) &&
              St.isHandledType(m)
            ) {
              let x = et.initial(a.getPath(_)),
                It = St.isHandledMethod(m, _.name);
              h.start(m, x, b);
              let at = Reflect.apply(
                  _,
                  h.preferredThisArg(_, T, m),
                  It ? b.map((pi) => B(pi)) : b
                ),
                Ac = h.isChanged(m, n),
                Cn = h.stop();
              if (
                ...
                E(et.get(i, mn), gn, m, Cn, pi)
                  ? O(mn, gn, m, Cn, pi)
                  : h.undo(m);
              }
              return (T instanceof Map || T instanceof Set) && un(at)
                ? ln(at, _, T, x, L)
                : at;
            }
  ...
  function ar(i, t, e = "") {
    ...
    for (let o of r)
      Object.prototype.hasOwnProperty.call(t, o) ||
        (Array.isArray(i) ? i.splice(parseInt(o), 1) : delete i[o]);
    for (let o of n)
      Object.prototype.hasOwnProperty.call(i, o) || (i[o] = t[o]);
    for (let o of n)
    ...
    _t = class {
      constructor(t, e) {
        ...
        P(this, qe, t),
          ...
          P(
            this,
            ai,
            Rn(p(this, Ee), vt(this, lr, hc).bind(this), {
              onValidate: vt(this, ur, lc).bind(this),
            })
          ),
          P(this, Ut, null),
      ...
      load(t, e = !1) {
        return z(this, null, function* () {
          if (p(this, Ut))
            return st("Record.load() called twice!", p(this, it)), p(this, Ut);
      ...
      delete() {
        return z(this, null, function* () {
          ...
          return new Promise((e) => {
            var r, n;
            (r = p(this, G)) == null || r.once("delete", e),
              (n = p(this, G)) == null || n.delete();
          });
        });
      }
      _set(t, e) {
 ...
 Ignored: ${t} = ${JSON.stringify(e)}`);
    ...
    (hr = new WeakSet()),
    (fc = function (t) {
      nr(t, "server-data") || M("Incoming server data not valid."),
        ar(p(this, Ee), t, "shared");
    });
  var Q,
    ui,
    li,
    ...
    fr = class {
      ...
      emit(t, e) {
        (e === void 0 || ei(e, "emit-data")) &&
          p(this, Q).event.emit(`${p(this, Ot)}/${t}`, e);
      }
      get hostName() {
        return p(this, ne);
      }
  ...
  function Tn(i, t, e) {
    ...
    (function (o) {
      ...
      (r.forEach(function (o, s) {
        ...
        if (
          ((function (a, l, h) {
            ...
            for (let { name: O, value: B } of E) {
              if (
                O.startsWith("#") ||
                (yr.includes(O) && Sc.includes(a.tagName.toLowerCase()))
              )
                continue;
            ...
            for (let { name: O, value: B } of N)
              E[O] ||
                (yr.includes(O) && Sc.includes(l.tagName.toLowerCase())) ||
                Rr(l, O);
          })(o, n[s], e),
          o.nodeName.includes("-"))
        )
        ...
        let c = _c(o);
        if (
          (c && c !== _c(n[s]) && (n[s].textContent = c),
          o.childNodes.length || !n[s].childNodes.length)
        ) {
  ...
  function bn(i) {
    return z(this, null, function* () {
      ...
      (oe = document.createElement("div")),
        (oe.className = "p5party_info"),
        document.body.append(oe);
      let t = Nc(
        se({ auto: sessionStorage.getItem("auto") === "true" }, i.info())
      );
      function e() {
        let {
            appName: r,
      ...
      (vn = Cc(oe, e)),
        document.addEventListener("click", (r) => {
          ...
          !n ||
            ...
            n === "auto" &&
              (Z("auto", r.target.checked),
              sessionStorage.setItem("auto", String(r.target.checked))));
        }),
        (mc = setInterval(() => {
  ...
  function ph() {
    ...
    (p5.prototype.partyConnect = function (r, n, o = "_main", s) {
      ...
      (p5.prototype.partyIsHost = function () {
        return t === null
          ? (M("partyIsHost() called before partyConnect()"), !1)
          : t.isHost();
      }),
